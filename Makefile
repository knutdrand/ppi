...
test-all: ## run pytest, doctests, examples
	pytest --cov=ppi --cov-report html
	pytest --cov=ppi --cov-report html --cov-append scripts/*_example.py
	pytest --cov-report html --cov=ppi --cov-append --doctest-modules ppi/
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs_source/ppi.rst
	rm -f docs_source/modules.rst
	sphinx-apidoc -o docs_source/ ppi
